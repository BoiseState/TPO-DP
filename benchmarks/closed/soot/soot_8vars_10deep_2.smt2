...
(check-sat)
(push)
(assert (le x6 soot.jimple.internal.JAssignStmt))
(check-sat)
(pop)
(push)
(assert (not (le x6 soot.jimple.internal.JAssignStmt)))
(check-sat)
(pop)
(pop)
(push)
...
(check-sat)
(push)
(assert (not (le x3 soot.coffi.InnerClasses_attribute)))
(check-sat)
(pop)
(push)
(assert (le x3 soot.coffi.InnerClasses_attribute))
(check-sat)
(pop)
(push)
(assert (le x7 java.lang.String))
