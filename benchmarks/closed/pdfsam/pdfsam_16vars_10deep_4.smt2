...
(pop)
(push)
(assert (le x3 org.jaxen.expr.PredicateSet))
(check-sat)
(pop)
(push)
(assert (not (le x3 org.jaxen.expr.PredicateSet)))
(check-sat)
(push)
(assert (le x7 java.lang.reflect.Field))
(check-sat)
...
(pop)
(push)
(assert (le x10 com.lowagie.text.pdf.PdfIndirectObject))
(check-sat)
(push)
(assert (le x4 com.lowagie.text.pdf.PdfObject))
(check-sat)
...
(pop)
(push)
(assert (not (le x10 com.lowagie.text.pdf.PdfIndirectObject)))
(check-sat)
(pop)
(pop)
(push)
