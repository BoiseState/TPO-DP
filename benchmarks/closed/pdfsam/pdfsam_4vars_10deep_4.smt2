...
(check-sat)
(push)
(assert (le x0 org.jaxen.util.SingleObjectIterator))
(check-sat)
(pop)
(push)
(assert (not (le x0 org.jaxen.util.SingleObjectIterator)))
(check-sat)
(push)
(assert (le x3 java.lang.String))
(check-sat)
...
(pop)
(push)
(assert (le x0 com.lowagie.text.pdf.RandomAccessFileOrArray))
(check-sat)
(push)
(assert (le x1 java.lang.String))
(check-sat)
...
(pop)
(push)
(assert (not (le x0 com.lowagie.text.pdf.RandomAccessFileOrArray)))
(check-sat)
(push)
(assert (le x3 java.lang.StringBuffer))
(check-sat)
