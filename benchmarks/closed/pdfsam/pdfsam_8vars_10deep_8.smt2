...
(check-sat)
(push)
(assert (le x7 org.jaxen.util.SingleObjectIterator))
(check-sat)
(pop)
(push)
(assert (not (le x7 org.jaxen.util.SingleObjectIterator)))
(check-sat)
(pop)
(pop)
(pop)
...
(check-sat)
(push)
(assert (le x3 com.lowagie.text.pdf.RandomAccessFileOrArray))
(check-sat)
(push)
(assert (le x7 java.lang.String))
(check-sat)
...
(pop)
(push)
(assert (not (le x3 com.lowagie.text.pdf.RandomAccessFileOrArray)))
(check-sat)
(pop)
(pop)
(push)
