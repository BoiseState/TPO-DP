...
(pop)
(push)
(assert (le x9 weka.classifiers.trees.M5P))
(check-sat)
(push)
...
(pop)
(push)
(assert (not (le x9 weka.classifiers.trees.M5P)))
(check-sat)
(pop)
(push)
...
(check-sat)
(push)
(assert (le x9 weka.core.matrix.LUDecomposition))
(check-sat)
(pop)
(push)
(assert (not (le x9 weka.core.matrix.LUDecomposition)))
(check-sat)
(push)
(assert (le x2 java.lang.String))
(check-sat)
...
(check-sat)
(push)
(assert (le x15 weka.core.converters.ConverterUtils_currencysign_DataSource))
(check-sat)
(pop)
(push)
(assert (not (le x15 weka.core.converters.ConverterUtils_currencysign_DataSource)))
(check-sat)
(pop)
(pop)
(push)
