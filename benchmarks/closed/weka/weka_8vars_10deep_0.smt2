...
(pop)
(push)
(assert (le x7 weka.classifiers.trees.j48.BinC45Split))
(check-sat)
(pop)
(push)
...
(check-sat)
(push)
(assert (not (le x7 weka.classifiers.trees.j48.BinC45Split)))
(check-sat)
(push)
...
(check-sat)
(push)
(assert (le x7 weka.core.matrix.LinearRegression))
(check-sat)
(pop)
(push)
(assert (not (le x7 weka.core.matrix.LinearRegression)))
(check-sat)
(pop)
(push)
