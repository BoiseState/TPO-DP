...
(check-sat)
(push)
(assert (le x13 weka.filters.unsupervised.attribute.Remove))
(check-sat)
(pop)
(push)
(assert (not (le x13 weka.filters.unsupervised.attribute.Remove)))
(check-sat)
(pop)
(push)
...
(pop)
(push)
(assert (le x12 weka.classifiers.trees.m5.RuleNode))
(check-sat)
(pop)
(push)
(assert (not (le x12 weka.classifiers.trees.m5.RuleNode)))
(check-sat)
(push)
(assert (le x0 weka.core.AttributeLocator))
(check-sat)
...
(pop)
(push)
(assert (le x14 weka.core.matrix.LUDecomposition))
(check-sat)
(pop)
(push)
(assert (not (le x14 weka.core.matrix.LUDecomposition)))
(check-sat)
(push)
(assert (le x10 java.lang.String))
(check-sat)
...
(pop)
(push)
(assert (le x12 java.io.ObjectOutputStream))
(check-sat)
(pop)
(push)
(assert (not (le x12 java.io.ObjectOutputStream)))
(check-sat)
(pop)
(pop)
(pop)
