...
(pop)
(push)
(assert (le x0 weka.classifiers.trees.j48.GainRatioSplitCrit))
(check-sat)
(push)
(assert (le x1 java.lang.String))
(check-sat)
...
(pop)
(push)
(assert (le x0 weka.classifiers.trees.j48.EntropyBasedSplitCrit))
(check-sat)
(push)
(assert (le x4 java.lang.StringBuilder))
(check-sat)
...
(pop)
(push)
(assert (not (le x0 weka.classifiers.trees.j48.EntropyBasedSplitCrit)))
(check-sat)
(pop)
(pop)
(pop)
(push)
(assert (not (le x0 weka.classifiers.trees.j48.GainRatioSplitCrit)))
(check-sat)
(push)
(assert (le x6 weka.core.Instance))
(check-sat)
