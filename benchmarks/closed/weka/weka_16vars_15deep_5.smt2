...
(check-sat)
(push)
(assert (le x12 weka.classifiers.trees.j48.C45PruneableClassifierTree))
(check-sat)
(pop)
(push)
(assert (not (le x12 weka.classifiers.trees.j48.C45PruneableClassifierTree)))
(check-sat)
(pop)
(pop)
(pop)
...
(pop)
(push)
(assert (le x6 weka.filters.unsupervised.attribute.MakeIndicator))
(check-sat)
(pop)
(push)
(assert (not (le x6 weka.filters.unsupervised.attribute.MakeIndicator)))
(check-sat)
(pop)
(push)
(assert (le x7 weka.core.Instance))
