...
(pop)
(push)
(assert (le x12 weka.core.matrix.LUDecomposition))
(check-sat)
(push)
(assert (= x4 java.lang.String))
(check-sat)
...
(pop)
(push)
(assert (not (le x12 weka.core.matrix.LUDecomposition)))
(check-sat)
(pop)
(push)
(assert (le x9 weka.core.Instances))
...
(check-sat)
(push)
(assert (le x14 weka.core.OptionHandler))
(check-sat)
(pop)
(push)
(assert (not (le x14 weka.core.OptionHandler)))
(check-sat)
(pop)
(push)
