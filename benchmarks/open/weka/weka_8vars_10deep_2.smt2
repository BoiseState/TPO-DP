...
(check-sat)
(push)
(assert (= x6 weka.classifiers.trees.j48.NoSplit))
(check-sat)
(pop)
(push)
(assert (not (= x6 weka.classifiers.trees.j48.NoSplit)))
(check-sat)
(pop)
(push)
(assert (le x5 weka.core.FastVector))
...
(pop)
(push)
(assert (= x3 weka.classifiers.trees.m5.YongSplitInfo))
(check-sat)
(pop)
(push)
(assert (not (= x3 weka.classifiers.trees.m5.YongSplitInfo)))
(check-sat)
(pop)
(push)
(assert (= x6 java.lang.String))
...
(pop)
(push)
(assert (le x3 weka.core.OptionHandler))
(check-sat)
(push)
(assert (= x4 java.lang.Boolean))
(check-sat)
...
(pop)
(push)
(assert (not (le x3 weka.core.OptionHandler)))
(check-sat)
(push)
(assert (= x0 java.lang.String))
(check-sat)
...
(check-sat)
(push)
(assert (le x2 weka.filters.supervised.attribute.Discretize))
(check-sat)
(pop)
(push)
(assert (not (le x2 weka.filters.supervised.attribute.Discretize)))
(check-sat)
(pop)
(pop)
(push)
