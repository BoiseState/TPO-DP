...
(pop)
(push)
(assert (le x2 weka.classifiers.CostMatrix))
(check-sat)
(push)
...
(pop)
(push)
(assert (not (le x2 weka.classifiers.CostMatrix)))
(check-sat)
(push)
(assert (= x2 java.lang.String))
(check-sat)
...
(pop)
(push)
(assert (le x1 weka.classifiers.trees.j48.BinC45Split))
(check-sat)
(pop)
(push)
(assert (le x1 weka.classifiers.trees.j48.ClassifierSplitModel))
(check-sat)
(push)
(assert (not (le x1 weka.classifiers.trees.j48.BinC45Split)))
(check-sat)
(push)
