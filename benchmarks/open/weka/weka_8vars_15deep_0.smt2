...
(check-sat)
(push)
(assert (le x4 weka.core.matrix.LinearRegression))
(check-sat)
(pop)
(push)
(assert (not (le x4 weka.core.matrix.LinearRegression)))
(check-sat)
(pop)
(push)
...
(pop)
(push)
(assert (not (le x6 java.io.ObjectOutputStream)))
(check-sat)
(pop)
(pop)
(push)
...
(pop)
(push)
(assert (le x6 weka.classifiers.trees.j48.C45Split))
(check-sat)
(pop)
(push)
(assert (not (le x6 weka.classifiers.trees.j48.C45Split)))
(check-sat)
(push)
(assert (le x6 weka.classifiers.trees.j48.C45Split))
(check-sat)
