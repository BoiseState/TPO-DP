...
(pop)
(push)
(assert (le x1 java.awt.image.SinglePixelPackedSampleModel))
(check-sat)
(pop)
(push)
(assert (= x1 java.awt.PageAttributes))
...
(pop)
(push)
(assert (le x1 weka.core.ClassDiscovery_currencysign_StringCompare))
(check-sat)
(pop)
(push)
(assert (le x1 java.beans.PropertyDescriptor))
(check-sat)
(pop)
(push)
...
(pop)
(push)
(assert (= x1 java.awt.DisplayMode))
(check-sat)
(pop)
(push)
...
(pop)
(push)
(assert (le x1 java.awt.image.ComponentSampleModel))
(check-sat)
(pop)
(push)
...
(check-sat)
(push)
(assert (not (le x1 weka.core.ClassDiscovery_currencysign_StringCompare)))
(check-sat)
(push)
...
(check-sat)
(push)
(assert (not (= x1 java.awt.DisplayMode)))
(check-sat)
(push)
...
(check-sat)
(push)
(assert (not (le x1 weka.estimators.Estimator)))
(check-sat)
(push)
...
(pop)
(push)
(assert (le x1 weka.estimators.Estimator))
(check-sat)
(pop)
(push)
