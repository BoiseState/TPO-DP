...
(check-sat)
(push)
(assert (not (le x0 weka.classifiers.trees.j48.BinC45Split)))
(check-sat)
(pop)
(pop)
(pop)
(push)
(assert (le x0 weka.classifiers.trees.j48.BinC45Split))
(check-sat)
(pop)
(push)
(assert (le x0 weka.classifiers.trees.j48.C45Split))
...
(check-sat)
(push)
(assert (= x0 weka.classifiers.trees.j48.NoSplit))
(check-sat)
(pop)
(push)
(assert (not (= x0 weka.classifiers.trees.j48.NoSplit)))
(check-sat)
(pop)
(pop)
(push)
...
(pop)
(push)
(assert (not (le x2 weka.core.scripting.JythonSerializableObject)))
(check-sat)
(push)
(assert (le x1 weka.core.Attribute))
(check-sat)
...
(pop)
(push)
(assert (le x2 weka.core.scripting.JythonSerializableObject))
(check-sat)
(pop)
(pop)
(push)
