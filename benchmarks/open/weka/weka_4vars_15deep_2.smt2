...
(check-sat)
(push)
(assert (le x2 weka.classifiers.trees.j48.PruneableClassifierTree))
(check-sat)
(pop)
(push)
(assert (not (le x2 weka.classifiers.trees.j48.PruneableClassifierTree)))
(check-sat)
(push)
(assert (= x3 java.lang.String))
(check-sat)
...
(pop)
(push)
(assert (le x3 weka.classifiers.trees.j48.BinC45Split))
(check-sat)
(pop)
(push)
...
(check-sat)
(push)
(assert (not (le x3 weka.classifiers.trees.j48.BinC45Split)))
(check-sat)
(pop)
(pop)
(pop)
...
(check-sat)
(push)
(assert (le x3 java.io.PrintWriter))
(check-sat)
(pop)
(push)
(assert (not (le x3 java.io.PrintWriter)))
(check-sat)
(pop)
(pop)
(push)
