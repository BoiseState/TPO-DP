...
(check-sat)
(push)
(assert (le x5 weka.classifiers.evaluation.ThresholdCurve))
(check-sat)
(push)
(assert (le x4 java.util.Vector))
(check-sat)
...
(pop)
(push)
(assert (not (le x5 weka.classifiers.evaluation.ThresholdCurve)))
(check-sat)
(pop)
(pop)
(push)
...
(pop)
(push)
(assert (le x4 weka.classifiers.CostMatrix))
(check-sat)
(pop)
(push)
(assert (not (le x4 weka.classifiers.CostMatrix)))
(check-sat)
(push)
(assert (= x4 java.lang.String))
(check-sat)
...
(pop)
(push)
(assert (not (le x5 weka.classifiers.trees.m5.M5Base)))
(check-sat)
(pop)
(pop)
(push)
...
(check-sat)
(push)
(assert (le x4 weka.classifiers.rules.ZeroR))
(check-sat)
(pop)
(push)
(assert (not (le x4 weka.classifiers.rules.ZeroR)))
(check-sat)
(pop)
(pop)
(push)
...
(check-sat)
(push)
(assert (le x4 java.util.Random))
(check-sat)
(pop)
(push)
(assert (not (le x4 java.util.Random)))
(check-sat)
(push)
(assert (le x7 weka.core.FastVector))
(check-sat)
...
(check-sat)
(push)
(assert (le x5 weka.classifiers.trees.j48.ModelSelection))
(check-sat)
(push)
(assert (le x1 weka.core.FastVector))
(check-sat)
...
(pop)
(push)
(assert (le x5 weka.classifiers.trees.j48.C45ModelSelection))
(check-sat)
(push)
(assert (le x5 weka.classifiers.trees.j48.ModelSelection))
(check-sat)
(pop)
(push)
(assert (not (le x5 weka.classifiers.trees.j48.ModelSelection)))
(check-sat)
(pop)
(push)
(assert (le x1 weka.core.Instances))
...
(pop)
(push)
(assert (not (le x5 weka.classifiers.trees.j48.C45ModelSelection)))
(check-sat)
(pop)
(push)
(assert (le x7 java.util.Vector))
...
(check-sat)
(push)
(assert (le x1 weka.classifiers.evaluation.output.prediction.AbstractOutput))
(check-sat)
(push)
(assert (le x4 weka.core.Instance))
(check-sat)
...
(pop)
(push)
(assert (not (le x1 weka.classifiers.evaluation.output.prediction.AbstractOutput)))
(check-sat)
(push)
(assert (le x0 weka.core.Instance))
(check-sat)
...
(pop)
(push)
(assert (not (le x0 weka.core.scripting.JythonSerializableObject)))
(check-sat)
(pop)
(push)
(assert (le x0 weka.core.scripting.JythonSerializableObject))
(check-sat)
(push)
(assert (le x7 java.util.Vector))
(check-sat)
