...
(pop)
(push)
(assert (not (le x3 weka.core.scripting.JythonSerializableObject)))
(check-sat)
(push)
(assert (le x1 weka.core.Capabilities))
(check-sat)
...
(pop)
(push)
(assert (le x3 weka.core.scripting.JythonSerializableObject))
(check-sat)
(push)
(assert (le x1 weka.core.Capabilities))
(check-sat)
...
(pop)
(push)
(assert (le x3 weka.classifiers.evaluation.NominalPrediction))
(check-sat)
(pop)
(push)
(assert (not (le x3 weka.classifiers.evaluation.NominalPrediction)))
(check-sat)
(pop)
(push)
(assert (le x2 weka.core.Instances))
