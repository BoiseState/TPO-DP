...
(pop)
(push)
(assert (not (le x7 weka.classifiers.trees.j48.ClassifierTree)))
(check-sat)
(pop)
(pop)
(push)
...
(check-sat)
(push)
(assert (le x6 weka.classifiers.trees.j48.ModelSelection))
(check-sat)
(push)
(assert (le x7 java.lang.Object))
(check-sat)
(push)
(assert (le x6 weka.classifiers.trees.j48.C45ModelSelection))
(check-sat)
(pop)
(push)
(assert (not (le x6 weka.classifiers.trees.j48.C45ModelSelection)))
(check-sat)
(pop)
(pop)
(push)
...
(pop)
(push)
(assert (not (le x6 weka.classifiers.trees.j48.ModelSelection)))
(check-sat)
(pop)
(pop)
(pop)
