...
(check-sat)
(push)
(assert (le x1 weka.core.converters.ArffLoader))
(check-sat)
(push)
(assert (le x0 weka.core.FastVector))
(check-sat)
...
(pop)
(push)
(assert (not (le x1 weka.core.converters.ArffLoader)))
(check-sat)
(pop)
(push)
(assert (le x1 weka.core.converters.ArffLoader))
...
(pop)
(push)
(assert (le x1 weka.core.converters.ArffLoader_currencysign_ArffReader))
(check-sat)
(push)
(assert (le x1 weka.core.converters.ArffLoader_currencysign_ArffReader))
(check-sat)
...
(pop)
(push)
(assert (not (le x1 weka.core.converters.ArffLoader_currencysign_ArffReader)))
(check-sat)
(pop)
(push)
(assert (= x2 java.lang.Boolean))
...
(check-sat)
(push)
(assert (le x1 java.lang.ClassLoader))
(check-sat)
(push)
(assert (le x2 weka.core.Instance))
(check-sat)
...
(pop)
(push)
(assert (not (le x1 java.lang.ClassLoader)))
(check-sat)
(pop)
(pop)
(push)
...
(pop)
(push)
(assert (le x1 weka.core.matrix.LUDecomposition))
(check-sat)
(push)
(assert (le x3 weka.core.Capabilities))
(check-sat)
...
(pop)
(push)
(assert (not (le x1 weka.core.matrix.LUDecomposition)))
(check-sat)
(push)
(assert (le x3 weka.core.Capabilities))
(check-sat)
