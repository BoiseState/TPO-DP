...
(pop)
(push)
(assert (le x10 weka.classifiers.Classifier))
(check-sat)
(pop)
(push)
(assert (not (le x10 weka.classifiers.Classifier)))
(check-sat)
(pop)
(pop)
(push)
...
(pop)
(push)
(assert (not (le x6 weka.classifiers.trees.m5.RuleNode)))
(check-sat)
(pop)
(pop)
(pop)
...
(pop)
(push)
(assert (le x8 weka.classifiers.Classifier))
(check-sat)
(push)
(assert (= x14 java.lang.Boolean))
(check-sat)
...
(pop)
(push)
(assert (not (le x8 weka.classifiers.Classifier)))
(check-sat)
(pop)
(pop)
(push)
...
(pop)
(push)
(assert (= x10 weka.core.Capabilities_currencysign_Capability))
(check-sat)
(pop)
(push)
(assert (not (= x10 weka.core.Capabilities_currencysign_Capability)))
(check-sat)
(push)
(assert (le x11 weka.core.Instances))
(check-sat)
