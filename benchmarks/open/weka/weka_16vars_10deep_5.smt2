...
(check-sat)
(push)
(assert (le x8 weka.classifiers.bayes.NaiveBayes))
(check-sat)
(push)
(assert (le x3 weka.core.Queue_currencysign_QueueNode))
(check-sat)
...
(pop)
(push)
(assert (not (le x8 weka.classifiers.bayes.NaiveBayes)))
(check-sat)
(pop)
(pop)
(push)
...
(check-sat)
(push)
(assert (le x4 weka.core.AttributeStats))
(check-sat)
(pop)
(push)
(assert (not (le x4 weka.core.AttributeStats)))
(check-sat)
(pop)
(push)
(assert (le x8 weka.core.Instance))
...
(pop)
(push)
(assert (le x8 java.io.PrintWriter))
(check-sat)
(pop)
(push)
(assert (not (le x8 java.io.PrintWriter)))
(check-sat)
(pop)
(push)
(assert (le x5 weka.core.Instances))
