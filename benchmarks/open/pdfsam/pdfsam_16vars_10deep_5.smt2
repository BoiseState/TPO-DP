...
(check-sat)
(push)
(assert (le x2 jcmdline.AbstractParameter))
(check-sat)
(push)
(assert (le x2 jcmdline.AbstractParameter))
(check-sat)
(pop)
(push)
(assert (not (le x2 jcmdline.AbstractParameter)))
(check-sat)
(push)
...
(pop)
(push)
(assert (le x10 com.lowagie.text.pdf.PRTokeniser))
(check-sat)
(pop)
(push)
(assert (not (le x10 com.lowagie.text.pdf.PRTokeniser)))
(check-sat)
(pop)
(pop)
(push)
