...
(check-sat)
(push)
(assert (le x5 org.pdfsam.console.business.parser.validators.MixCmdValidator))
(check-sat)
(pop)
(push)
(assert (not (le x5 org.pdfsam.console.business.parser.validators.MixCmdValidator)))
(check-sat)
(push)
