...
(pop)
(push)
(assert (le x12 soot.SootMethod))
(check-sat)
(pop)
(push)
(assert (not (le x12 soot.SootMethod)))
(check-sat)
(push)
...
(pop)
(push)
(assert (le x15 soot.jimple.toolkits.typing.fast.UseChecker))
(check-sat)
(push)
(assert (= x6 java.lang.String))
(check-sat)
...
(pop)
(push)
(assert (not (le x15 soot.jimple.toolkits.typing.fast.UseChecker)))
(check-sat)
(pop)
(push)
(assert (le x7 java.io.File))
...
(check-sat)
(push)
(assert (le x13 soot.coffi.ClassFile))
(check-sat)
(push)
(assert (le x7 soot.coffi.CONSTANT_Utf8_info))
(check-sat)
...
(pop)
(push)
(assert (not (le x13 soot.coffi.ClassFile)))
(check-sat)
(pop)
(push)
(assert (= x7 java.lang.String))
...
(pop)
(push)
(assert (le x13 soot.jimple.spark.ondemand.genericutil.ArraySet))
(check-sat)
(pop)
(push)
...
(pop)
(push)
(assert (not (le x13 java.util.LinkedList)))
(check-sat)
(pop)
(pop)
(push)
...
(pop)
(push)
(assert (le x13 soot.util.ArraySet))
(check-sat)
(push)
(assert (le x3 java.util.zip.ZipEntry))
(check-sat)
...
(pop)
(push)
(assert (not (le x13 soot.util.IterableSet)))
(check-sat)
(push)
...
(pop)
(push)
(assert (not (le x13 soot.PatchingChain)))
(check-sat)
(push)
...
(pop)
(push)
(assert (le x13 soot.util.IterableSet))
(check-sat)
(pop)
(push)
