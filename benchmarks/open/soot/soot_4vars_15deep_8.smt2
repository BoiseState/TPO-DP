...
(pop)
(push)
(assert (not (le x2 soot.ArrayType)))
(check-sat)
(push)
(assert (= x0 java.lang.String))
(check-sat)
...
(check-sat)
(push)
(assert (= x2 soot.util.NumberedString))
(check-sat)
(pop)
(push)
(assert (not (= x2 soot.util.NumberedString)))
(check-sat)
(pop)
(pop)
(push)
...
(pop)
(push)
(assert (le x2 soot.jimple.DefinitionStmt))
(check-sat)
(push)
(assert (le x1 java.util.zip.ZipEntry))
(check-sat)
...
(pop)
(push)
(assert (not (le x2 soot.jimple.DefinitionStmt)))
(check-sat)
(push)
(assert (le x2 soot.jimple.DefinitionStmt))
(check-sat)
...
(pop)
(push)
(assert (not (le x2 java.util.AbstractSet)))
(check-sat)
(push)
(assert (= x0 java.lang.String))
(check-sat)
...
(check-sat)
(push)
(assert (le x2 soot.tagkit.AbstractHost))
(check-sat)
(pop)
(push)
(assert (not (le x2 soot.tagkit.AbstractHost)))
(check-sat)
(pop)
(push)
(assert (le x1 java.util.zip.ZipEntry))
