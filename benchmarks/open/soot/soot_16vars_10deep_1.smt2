...
(check-sat)
(push)
(assert (le x14 soot.toolkits.scalar.BackwardFlowAnalysis))
(check-sat)
(pop)
(push)
(assert (not (le x14 soot.toolkits.scalar.BackwardFlowAnalysis)))
(check-sat)
(pop)
(pop)
(push)
...
(check-sat)
(push)
(assert (le x14 soot.coffi.CONSTANT_Double_info))
(check-sat)
(pop)
(push)
(assert (not (le x14 soot.coffi.CONSTANT_Double_info)))
(check-sat)
(pop)
(push)
(assert (= x10 java.lang.String))
...
(pop)
(push)
(assert (le x8 java.util.jar.JarFile))
(check-sat)
(pop)
(push)
(assert (le x8 java.util.zip.ZipFile))
(check-sat)
(push)
(assert (not (le x8 java.util.jar.JarFile)))
(check-sat)
(pop)
(pop)
(pop)
